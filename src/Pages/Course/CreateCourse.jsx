...
const CreateCourse = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    // calling the api
    dispatchCreateNewCourse();
  };

  // asynchronous function to dispatch createNewCourse
  const dispatchCreateNewCourse = async () => {
    try {
      console.log("Api create course called");
      const res = await dispatch(createNewCourse(userInput));
      console.log("Api create course done well");
